export default {
    ...
    "home": {
        "navs": [
            { "text": "关于我们", "link": "/about-us", "img": "/img/new/banner.png" },
            { "text": "酒单", "link": "/wine-list", "img": "/img/new/2nd.jpg" },
            { "text": "新酒到货", "link": "/new-arrivals", "img": "/img/new/new-arrival.jpg" },
            { "text": "特别推介", "link": "/special-offers", "img": "/img/new/special-offers.jpg" },
            { "text": "联系我们", "link": "/contact-us", "img": "/img/new/3rd.jpg" }
        ]
    },
    "about-us": {
        "title" : "关于我们",
        "paragraph": "葡萄酒文化源远流长，每年从各地生产的葡萄酒多不胜数，在如此多种类的葡萄酒中，挑选出符合自己口味的葡萄酒可谓是沙中淘金。我们的使命是替客人在琳琅满目的葡萄酒种类中，根据客人需求及口味，挑选出符合要求的葡萄酒。我们期望每位客人来到香贝田酒业有限公司都能够选择到适合的美酒，在品尝红酒的时候，能够在味觉、视觉、嗅觉中得到独一无二的感受，酒味亦能环绕口中，余韵无穷。本公司提供了多个地区，各具不同香气、口感、风味的葡萄酒，以供客人任意挑选，继而满载而归。我们深信每一瓶葡萄酒有其独特的灵魂及生命，其风味就像诉说它一生的故事，帮助每位客人找到所青睐的葡萄酒，是我们至高无上的荣幸。那就是<a href='http://www.cbtwines.co/contact-us' class='font-weight-bold lime--text'>香貝田酒業有限公司</a>。"
    },
    "contact-us": {
        "address_1" : "香港 九龙",
