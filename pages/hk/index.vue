<template>
    <v-container class="pa-0" fluid >
        <v-img src="/img/new/home.jpg" alt="garden" width="100%" class="text-center" contain>
            <v-row class="mb-3 ml-12" v-for="(nav, index) in navs" :key="index">
                <v-col :cols="1" ></v-col>
                <v-col :cols="3" >
...
export default {
    ...
    return {
        navs: [
            { text: '關於我們', link: '/cn/about-us', img: '/img/new/banner.png'},
            { text: '酒單', link: '/cn/winelist', img: '/img/new/2nd.jpg' },
            { text: '新酒到貨', link: '/cn/new-arrivals', img: '/img/new/new-arrival.jpg' },
            { text: '特别推介', link: '/special-offers', img: '/img/new/special-offers.jpg' },
            { text: '聯繫我們', link: '/cn/contact-us', img: '/img/new/3rd.jpg' },
        ]
        }
    },
    mounted() {
